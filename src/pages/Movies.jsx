      ...
      <section className="p-4">
        <div className="flex gap-7 lg:flex-row md:flex-col-reverse  flex-col-reverse">
          ...
          <div className="flex flex-col items-start  gap-3 p-4 rounded-lg lg:w-[30%]">
            ...
            {/* Movie Title */}
            <p className="text-white text-[25px] font-semibold mt-4">
              {data?.movieName}
            </p>

            {/* Movie Description */}
            <p className="text-white  mt-2 text-[13px]">
              When tech billionaire Slater King meets cocktail waitress Frida at
              his fundraising gala, he invites her to join him and his friends
              on a dream vacation on his private island. But things go terribly
              wrong
            </p>
            ...
            <div className=" mt-2 text-[13px] space-y-2">
              <p className="text-[#aaa]">
                <strong className="text-white">Genres:</strong> Thriller,
                Mystery, Horror
              </p>
              <p className="text-[#aaa]">
                <strong className="text-white">Cast:</strong> Simon Rex, Haley
                Joel Osment, Naomi Ackie
              </p>
              <p className="text-[#aaa]">
                <strong className="text-white">Production:</strong> Free
                Association, Bold Choices, Metro-Goldwyn-Mayer
              </p>
              <p className="text-[#aaa]">
                <strong className="text-white">Country:</strong> United States
                of America
              </p>
              <p className="text-white">
                <strong className="text-white">Duration:</strong> 103 min
              </p>
            </div>
            ...
            <div className="flex  gap-3">
              ...
              <div className="flex flex-col text-white gap-3">
                ...
                <div className="flex space-x-2 text-[#aaa]">
                  <button className="border-2  border-[#aaa] text-[10px]  font-bold rounded-md py-0 px-4 h-8  flex justify-center items-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="17"
                      height="17"
                  ...
                  <button className="border-2 border-[#aaa] text-[10px] font-bold rounded-md py-2 px-4 h-8 flex justify-center items-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="17"
                      height="17"
              ...
              <div className="">
                <button className="bg-[#f04f24] p-6 rounded-full">
                  <svg
                    ...
                    fill="currentColor"
                  >
                    <path d="M9.75 7.5v9l7.5-4.5-7.5-4.5z" />
                  </svg>
                </button>
              </div>
            </div>
